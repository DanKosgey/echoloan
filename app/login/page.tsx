    ...
    try {
      ...
      if (response.ok && data.token) {
        ...
        if (data.error === 'User not found') {
          // User doesn't exist, redirect to signup with the entered info
          router.push(`/register?name=${encodeURIComponent(name)}&phone=${encodeURIComponent(fullPhone)}`);
        } else {
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-md">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-10">Login to Your Account</h2>
